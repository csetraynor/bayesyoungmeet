...
It is not strange to find in a dataset missing time event or censored values or censoring indicator. We could impute them if we have got covariate values for those individuals. On the other hand, covariate values may also be missing for the same individuals, in that case these observations have to de disregarded. Just for now we will discard these observations.
